...
🧠 Technical Retrospective (개발 중 고민과 해결 과정)

**(느낀점)**
처음에는 단순 CRUD라고 생각했지만,
확장자 정책·보안·상태관리 등 생각보다 고려해야 할 요소가 많아 다양한 기술적 관점을 고민하게 된 프로젝트였습니다.
...
✅ 핵심 요약  
단순 CRUD를 넘어서  
보안(해시 처리) · 예외 처리 · 상태 관리 · 배포 환경(Render) 초기화 문제 대응까지  
고려하여 확장성 있는 구조로 개발.
